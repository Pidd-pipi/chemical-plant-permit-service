...
var opsTransitionTable = map[OpsStatus]map[OpsStatus]bool{
	...
	OpsStatusReview: {OpsStatusActive: true, OpsStatusPaused: true, OpsStatusClosed: true},
...
func opsStatusValid(value OpsStatus) bool {
	return value == OpsStatusQueued || value == OpsStatusReview || value == OpsStatusActive || value == OpsStatusPaused || value == OpsStatusClosed
}
